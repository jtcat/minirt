...
/*   Updated: 2024/03/31 21:44:02 by jcat             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	plane(t_ray *ray, t_vec2 distBound, t_vec3 normal, vec3 planeNormal, float planeDist)
{
    float	a;
    float	d;
...
bool	sphere(t_sphere *spec, t_ray *ray, t_vec2 bound, t_hit *hit)
{
	t_vec3	oc;
    float	b;
    float	c;
